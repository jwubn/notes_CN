...
format1_dir = '/Users/kuen/documents/5140/data/data_format1_20181007_20181014.h5'
format2_dir = '/Users/kuen/documents/5140/data/data_format2_20181007_20181014.h5'
...
class backTest:
    ...
    def pnl_analyze(self, strategyDetail):
        ...
        sharpe_ratio = np.sqrt(365) * ret_daily.mean() / ret_daily.std() # 252
